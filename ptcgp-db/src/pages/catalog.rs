...
fn SortHeader(sort_cfg: Signal<SortConfig>) -> Element {
    rsx! {
        div { class: "flex items-center shrink-0 px-3 py-1 text-xs font-medium text-gray-500 dark:text-gray-400 border-b border-gray-200/80 dark:border-gray-700/80 bg-gray-50 dark:bg-gray-800/80 shadow-sm gap-2",
