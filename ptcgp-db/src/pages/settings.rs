        ...
        div { class: "max-w-2xl mx-auto p-6 space-y-6",
            ...
            section {
                ...
                div { class: "bg-white dark:bg-gray-800 rounded-lg border \
                              border-gray-200/80 dark:border-gray-700/80 p-4 shadow-md dark:shadow-none dark:ring-1 dark:ring-white/[0.06]",
            ...
            section {
                ...
                div { class: "bg-white dark:bg-gray-800 rounded-lg border \
                              ...
                              divide-y divide-gray-100 dark:divide-gray-700 shadow-md dark:shadow-none dark:ring-1 dark:ring-white/[0.06]",
                    SettingToggle {
